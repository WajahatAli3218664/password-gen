...
st.markdown(
    ...
    .stButton>button:hover {
        background-color: #303F9F !important;  /* Darker indigo on hover */
    }
    ...
    /* Amazing Footer Styling with a new gradient background */
    .amazing-footer {
        width: 100%;
        padding: 20px;
        margin-top: 30px;
...
def main():
    ...
    # Button to Check Password - now with indigo color
